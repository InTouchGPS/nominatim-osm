...
require_once(CONST_LibDir.'/PlaceLookupRange.php');
...
$bAddressRange = $oParams->getBool('addressRange', false);

$oPlaceLookup = new Nominatim\PlaceLookupRange($oDB);
$oPlaceLookup->loadParamArray($oParams);
$oPlaceLookup->setIncludeAddressDetails($oParams->getBool('addressdetails', true));
$oPlaceLookup->setAddressRangeFlag($bAddressRange);
